...
public partial class QuanTri_ChiTiet_SanPham : System.Web.UI.Page
{
    ...
    protected void btnCapNhatSP_Click(object sender, EventArgs e)
    {
        ...
        //------------------------------
        if (mySanPham.update_sanpham(cmbNhomSP.SelectedValue, cmbTrangThai.SelectedValue, txtTenSanPham.Text, txtMoTa.Text, txtThuTu.Text, ckNoiDung.Text, cmbSlideShow.SelectedValue, txtGia.Text, FileName, cmbUuTien.SelectedValue, txtGiaKhuyenMai.Text, Request.QueryString["id"].ToString()) > 0)
        {
